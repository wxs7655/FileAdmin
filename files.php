...
#vidviewer,#imgviewer{width:calc(100% - 10px);height:calc(100vh - 100px);margin:5px;border:1px solid rgba(0,0,0,.1);border-radius:5px;object-fit:contain;outline:none;}
...
<html onmousedown="hideContextMenu()" oncontextmenu="showContextMenu()" onclick="if(!fileHoverSelecting){fileSelected=[];loadFileSelected();}" onmouseup="setTimeout(function(){fileHoverSelecting=false;},50)">
	...
	<body>
		<div class="title">
			<div class="appName" onclick="chkupd()">吴<b>先生</b><div id="versionNote">正在获取</div></div>
		...
		<div class="module login" data-module="login">
			<div class="loginTitle">登录 吴先生文件管理器</div>
